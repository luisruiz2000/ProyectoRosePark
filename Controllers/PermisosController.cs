...
namespace RosePark.Controllers
{
    public class PermisosController : Controller
    {
        ...
        public PermisosController(RoseParkDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPermisos,NombrePermiso,EstadoPermisos")] Permiso permiso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPermisos,NombrePermiso,EstadoPermisos")] Permiso permiso)
        {
